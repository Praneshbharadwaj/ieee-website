  ...
  return (
    ...
    >
      ...
      <p className="mb-5 text-base text-white">
        Enjoy membership benefits and information about the latest technologies.
      </p>
      <Link href={join}>
        <div className="mb-4 h-[50px] w-full cursor-pointer rounded-md bg-secondary text-center text-sm font-medium text-white transition duration-300 ease-in-out hover:bg-[#0BB489] hover:bg-opacity-90">
          <p className="pt-3.5">Explore</p>
        </div>
      </Link>
