        ...
        <div className="-mx-4 flex flex-wrap items-center">
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
            <div
              ...
              data-wow-delay=".2s"
            >
              <div className="mb-8 text-2xl font-semibold text-dark dark:text-white md:text-[28px] md:leading-[1.42]">
                Join Our Community! 🌟🚀
              </div>
              <div className="mb-12 text-lg text-body-color dark:text-dark-6">
                <p>
